const rules = {
  ...
  // 'no-control-regex': 2, // disallow control characters in regular expression
  ...
  // 'no-misleading-character-class': 2, // disallow characters which are made with multiple code points in character class syntax
  ...
  'curly': [2, 'multi-line', 'consistent'], // enforce consistent brace style for all control statements
  ...
  'array-bracket-newline': [2, {multiline: true}], // enforce linebreaks after opening and before closing array brackets
  ...
  'max-depth': [2, {max: 5}], // enforce a maximum depth that blocks can be nested
  'max-len': [
    2, {
      code: 120,
      tabWidth: 2,
  ...
  // 'max-lines-per-function': 2, // enforce a maximum number of line of code in a function
  ...
  'quotes': [2, 'single', {allowTemplateLiterals: true}], // enforce the consistent use of either backticks, double, or single quotes
